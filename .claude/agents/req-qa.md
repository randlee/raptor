---
name: req-qa
description: Validates implementation and documentation against project requirements, architecture/design, and project plan with strict compliance reporting
