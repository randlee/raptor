...
The package also owns the repository scan-authorization and source-routing models
used by `.raptor/sources.toml` and `.raptor/routing.toml`. Their normative field,
matching, and cross-file requirements are in
