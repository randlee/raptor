...
- No byte-unit parser, transform proof, SQLite import/export orchestration, template change, split/combine apply, external gate execution, migration CLI/agent activation, or certification.
